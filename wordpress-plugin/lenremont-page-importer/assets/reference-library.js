(function (root, factory) {
	...
	function build(wp, converter, config) {
		...
		var definitions = [
			...
			['messengers', 'Мессенджеры', 'Полоса контактных ссылок. Укажите собственные адреса.'],
			...
			['materials', 'Изображение и описание', 'Секция с изображением, вариантами и пояснением.'],
			...
			['logistics', 'Условия работы', 'Текст и контактная панель в двух колонках.'],
			['quality', 'Контроль качества', 'Заголовок и список проверок из исходной страницы.'],
		...
		patterns.push(pattern('page', 'Нейтральная страница / все секции', 'Полная сборка из 13 секций с текстом-рыбой. Замените содержимое и настройте ссылки.', [wrap(main.innerBlocks)], true));
