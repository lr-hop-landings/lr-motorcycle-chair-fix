...
В проекте будут форма, квиз и их версии в модальных окнах. Модальные окна будут вешаться на CTA. Все формы необходимо выполнить в соответствии с правилом ниже - важно учитывать требуемый формат структуры,валидации и прочего
